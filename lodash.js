...
declare module 'lodash' {
  declare class lodashArray {
    ...
    intersection<T>(...arrays: NestedArray<T>): Array<T>;
    ...
    xor<T>(...array: NestedArray<T>): Array<T>;
    //Workaround until (...parameter: T, parameter2: U) works
    ...
    zip<T>(...arrays: NestedArray<T>): NestedArray<T>;
  ...
  declare class lodashObject extends lodashNumber {
    ...
    transform(object: Object, iteratee?: OIteratee, accumulator?: any): any;
  ...
  // }
  declare class lodashString extends lodashObject {
