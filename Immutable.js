  ...
  */
  declare interface List<T> extends IndexedCollection<T> {
    ...
    */
    ...
    ort(comparator?: (valueA: T, valueB: T) => number): /*this*/List<T>;
    sortBy<C>(
      comparatorValueMapper: (value: T, key: number, iter: /*this*/List<T>) => C,
  ...
  */
  declare interface Map<K, V> extends KeyedCollection<K, V> {
    ...
    */
    ...
    sortBy<C>(
      comparatorValueMapper: (value: V, key: K, iter: /*this*/Map<K, V>) => C,
      comparator?: (valueA: C, valueB: C) => number
    ): /*this*/Map<K, V>;
