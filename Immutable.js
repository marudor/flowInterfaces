...
declare module 'immutable' {
  ...
  declare class List<T> extends IndexedCollection<T> {
    ...
    */
    ...
    map<M>(
      mapper: (value: T, key: number, iter: any) => M,
      context?: any
    ): /*this*/List<M>;
    filter(
      predicate: (value: T, key: number, iter: any) => any,
      context?: any
    ): /*this*/List<T>;
    filterNot(
      predicate: (value: T, key: number, iter: /*this*/any) => any,
      context?: any
    ): /*this*/List<T>;
    sort(comparator?: (valueA: T, valueB: T) => number): /*this*/List<T>;
    sortBy<C>(
      comparatorValueMapper: (value: T, key: number, iter: /*this*/any) => C,
  ...
  declare class Map<K, V> extends KeyedCollection<K, V> {
    ...
    */
    ...
    map<M>(
      mapper: (value: V, key: K, iter: any) => M,
      context?: any
    ): /*this*/Map<K, M>;
    filter(
      predicate: (value: V, key: K, iter: any) => any,
      context?: any
    ): /*this*/Map<K, V>;
    filterNot(
      predicate: (value: V, key: K, iter: /*this*/any) => any,
      context?: any
    ): /*this*/Map<K, V>;
    sort(comparator?: (valueA: V, valueB: V) => number): /*this*/Map<K, V>;
    sortBy<C>(
      comparatorValueMapper: (value: V, key: K, iter: /*this*/any) => C,
      comparator?: (valueA: C, valueB: C) => number
    ): /*this*/Map<K, V>;
    reverse(): /*this*/Map<K, V>;
  }
